...
require_once 'funcoes.php';/*include 'funcoes.php'; require arquivo obrigatorio o include nao, require_once, verifica se  o arquivo ja coi incluuido */

$contasCorrentes = [
    '123.256.789-10' => ['titular' => 'Maria', 'saldo' => 10000],
...
foreach ($contasCorrentes as $cpf => $conta) {*/
   ...
   /* ['titular' => $titular, 'saldo'=> $saldo] = $conta;*//*e uma lista => list=();*/
 //   exibeConta($conta);
//}
//echo '</ul>';
